            ...
            <main className="rounded-lg w-full  h-4/5 flex flex-col lg:flex-row xl:w-3/4">
                ...
                <div className="grid place-items-center rounded-b-lg lg:rounded-r-lg flex-1 py-3 lg:py-10  bg-gray-200">
                    ...
                    >
                        ...
                        <button className="bg-cyan-400 text-white font-semibold w-1/2 mx-auto py-2 mt-4 rounded-md" type="submit">Sign In</button>

                        <p className="mx-auto mt-4 mb-4">OR</p>
                        <button className="mx-auto flex items-center gap-3 bg-blue-600 pr-3 text-white font-semibold rounded-md mb-4">
                            <FcGoogle className="bg-white w-10 h-10 p-1 rounded-l-md" /> <span>Sign in with Google</span>
                        </button>
